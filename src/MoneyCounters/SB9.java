...
public class SB9 {
        ...
        comPort.addDataListener(new SerialPortDataListener() {
            ...
            public void serialEvent(SerialPortEvent serialPortEvent) {
                try {
                    ...
                    SerialReaderWorker worker = new SerialReaderWorker(bufferedInputStream, jProgressBar);
                    worker.execute();
                    ...
                    if (countData.get(6).equals("RSD"))
                        insertRSD(countData, MainWindow.jt_denom);
                    else if (countData.get(6).equals("USD"))
    ...
    public static String trainOcr(String result) {
        ...
        if (result.startsWith("ES ")) {
            ...
            fix = result.replaceAll("^E100", "E200");
